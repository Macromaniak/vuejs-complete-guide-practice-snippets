<template>
    <form @submit.prevent="submitForm">
        ...
        <div class="form-control" :class="{invalid: !rate.isValid}">
            ...
            <input type="number" id="hourlyrate" v-model.number="rate.val">
            <p v-if="!rate.isValid">Rate must be a valid number</p>
        </div>
        <div class="form-control" :class="{invalid: !areas.isValid}">
            ...
            <div>
                ...
                <label for="career">Career guidance</label>
            </div>
            <p v-if="!areas.isValid">Please select atleast one area of expertise!</p>
        </div>
        <p v-if="!formIsValid.isValid">Please fix the errors and submit again!</p>
